<div class="p-12 border-b border-b-gray-300 dark:border-b-gray-700 flex lg:flex-row flex-col h-full container">
    <div class="flex flex-col w-full justify-between">
        ...
        <div class="mt-4 flex">
            ...
            <a href="{{ route('resume') }}" class="text-white bg-dark-400 hover:bg-dark-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg px-5 py-2.5 text-center inline-flex items-center me-2">
